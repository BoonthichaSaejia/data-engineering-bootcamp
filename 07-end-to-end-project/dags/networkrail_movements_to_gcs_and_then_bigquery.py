...
GCS_BUCKET = "deb-bootcamp-100022"
BIGQUERY_DATASET = "networkrail"
KEYFILE = "/opt/airflow/dags/deb-1-by-skooldio-02-bigquery.json"
GCS_KEYFILE = "/opt/airflow/dags/deb-1-by-skooldio-03-gcs.json"
...
def _load_data_to_gcs(**context):
    ds = context["data_interval_start"].to_date_string()
    gcs_service_account_info = json.load(open(GCS_KEYFILE))
...
with DAG(
    ...
    # End
    end = EmptyOperator(task_id="end", trigger_rule="one_success") #only one become green, can be success
